    ...
    import ItemFormModal from '../items/components/ItemFormModal.vue';
    ...
    const columns: TableColumn<ShoppingItem>[] = [

        {
            ...
            meta: {
                class: {
                    th: 'sticky left-0 z-5 text-xs md:text-sm bg-default',
                    td: 'sticky left-0 z-5 text-xs md:text-sm bg-default',
                },
            },
        },
        {
        ...
        <div class="space-y-6">
            <div class="
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    <UButton color="primary" variant="outline" :loading="loading" @click="createItemModal">
                        + Novo item
                    </UButton>
                </div>
            </div>
            ...
            <div v-for="(categoryItems, category) in groupedItems" :key="category" class="space-y-2">
                ...
                <UCard>
                    <UTable :data="categoryItems" :columns="columns" :loading="loading" class="text-xs md:text-sm">
